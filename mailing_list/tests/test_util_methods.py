...
class MailingListUtilsTests(TestCase):
    ...
    def test_get_section_sis_enrollment_status_for_course_with_no_courseinstance(
        self, mock_get_ci
    ):
    ...
    @patch("mailing_list.utils.CourseInstance.objects.get")
    def test_get_section_sis_enrollment_status_when_cs_class_type_is_none(
        self, mock_get_ci
    ):
    ...
    @patch("mailing_list.utils.CourseInstance.objects.get")
    def test_get_section_sis_enrollment_status_when_cs_class_type_is_E(
        self, mock_get_ci
    ):
    ...
    @patch("mailing_list.utils.CourseInstance.objects.get")
    def test_get_section_sis_enrollment_status_when_cs_class_type_is_N(
        self, mock_get_ci
    ):
    ...
    @patch("mailing_list.utils.CourseInstance.objects.get")
    def test_get_section_sis_enrollment_status_when_cs_class_type_is_G(
        self, mock_get_ci
    ):
