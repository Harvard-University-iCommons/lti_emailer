...
class MailingListModelTests(TestCase):
    fixtures = ["mailing_list/fixtures/test_mailing_list.json"]
    longMessage = True
    ...
    def test_get_or_create_or_delete_mailing_lists_for_canvas_course_id_with_existing_list(
        self,
        mock_get_sections,
        ...
        result = MailingList.objects.get_or_create_or_delete_mailing_lists_for_canvas_course_id(
            3716
        )
        address_1 = settings.LISTSERV_SECTION_ADDRESS_FORMAT.format(
            canvas_course_id=3716, section_id=1582
        )
        address_2 = settings.LISTSERV_SECTION_ADDRESS_FORMAT.format(
            canvas_course_id=3716, section_id=1583
        )
    ...
    @patch("mailing_list.models.canvas_api_client.get_enrollments")
    @patch("mailing_list.models.canvas_api_client.get_sections")
    def test_get_or_create_or_delete_mailing_lists_for_canvas_course_id_with_new_list(
        self,
        mock_get_sections,
        mock_get_enrollments,
        mock_get_course,
        ...
        sections.append({"id": 1584, "name": "section name 3", "sis_section_id": None})
        ...
        address_3 = settings.LISTSERV_SECTION_ADDRESS_FORMAT.format(
            canvas_course_id=3716, section_id=1584
        )
    ...
    @patch("mailing_list.models.canvas_api_client.get_enrollments")
    @patch("mailing_list.models.canvas_api_client.get_sections")
    def test_get_or_create_or_delete_mailing_lists_for_canvas_course_id_with_deleted_section(
        self,
        mock_get_sections,
        mock_get_enrollments,
        mock_get_course,
    ...
    @patch("mailing_list.models.canvas_api_client.get_enrollments")
    @patch("mailing_list.models.canvas_api_client.get_sections")
    def test_get_or_create_or_delete_mailing_lists_for_canvas_course_id_with_multiple_primary_sections(
        self,
        mock_get_sections,
        mock_get_enrollments,
        mock_get_course,
        ...
        sections.append({"id": None, "name": "Test Course", "sis_section_id": "123456"})
    ...
    @patch("mailing_list.models.canvas_api_client.get_enrollments")
    @patch("mailing_list.models.canvas_api_client.get_sections")
    def test_get_or_create_or_delete_mailing_lists_for_canvas_course_id_with_non_crosslisted_course(
        self,
        mock_get_sections,
        mock_get_enrollments,
        mock_get_course,
    ...
    def test_parse_address_with_section_list(self):
        ...
        list_address = settings.LISTSERV_SECTION_ADDRESS_FORMAT.format(
            canvas_course_id=3716, section_id=12345
        )
        result = MailingList.objects._parse_address(list_address)
    ...
    @patch("mailing_list.models.MailingList.objects.get")
    def test_get_or_create_or_delete_mailing_list_by_address_with_section_calls_get_with_correct_args(
        self, mock_get_mailing_list, mock_get_section
    ):
        ...
        MailingList.objects.get_or_create_or_delete_mailing_list_by_address(
            list_address
        )
        mock_get_mailing_list.assert_called_with(
            canvas_course_id=3716, section_id=12345
        )

    @patch("mailing_list.models.canvas_api_client.get_section")
    @patch("mailing_list.models.MailingList.objects.get")
    def test_get_or_create_or_delete_mailing_list_by_address_with_none_as_section_calls_get_with_correct_args(
        self, mock_get_mailing_list, mock_get_section
    ):
        ...
        mock_get_mailing_list.assert_called_with(
            canvas_course_id=3716, section_id__isnull=True
        )
