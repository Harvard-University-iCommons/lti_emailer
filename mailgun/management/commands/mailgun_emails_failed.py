...
class Command(BaseCommand):
    help = "Prints a list of emails with permanent failures in a given time window"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=_datetime,
            required=True,
            help="End of the window to look for emails, formatted as YYYYMMDDHHMMSS",
        )
        parser.add_argument(
            "--output-file",
    ...
    def process_events(self, events, output_file):
        ...
        for event in events:
            ...
            try:
                ...
                list_addresses = [
                    a
                    for a in event["message"]["recipients"]
