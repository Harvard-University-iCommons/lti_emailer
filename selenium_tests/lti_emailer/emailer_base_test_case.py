...
from selenium_common.canvas.canvas_masquerade_page_object import (
    CanvasMasqueradePageObject,
)
from selenium_tests.lti_emailer.page_objects.emailer_mainpage_page_object import (
    EmailerMainPage,
)
from canvas_sdk.methods.external_tools import (
...
class EmailerBaseTestCase(BaseSeleniumTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.masquerade_page = CanvasMasqueradePageObject(driver, cls.CANVAS_BASE_URL)
        ...
        try:
            ...
            logger.debug(f"Successful tool lookup: {resp}")
        ...
        if tool_does_not_exist:
            ...
            try:
                ...
                logger.debug("Successful Create:")
    ...
    def tearDownClass(cls):
        ...
        if cls.new_external_id > 0:
            try:
                ...
                logger.debug(f"Successful Delete: {resp}")
            except CanvasAPIError as api_error:
                logger.error(
